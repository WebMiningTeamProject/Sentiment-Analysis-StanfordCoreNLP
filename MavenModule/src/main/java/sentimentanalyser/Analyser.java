...
public class Analyser {
	...
	/**
	 * Finds the average sentiment.
	 * @param bow The string for which the sentiment is to be found.
	 * @return The sentiment score, ranges from XX to YY.
	 */
	public int findSentimentAverage(String bow){
		...
		for (CoreMap sentence : sentences) {
			...
			//System.out.println("Sentence "+ senCounter + partText);
			//System.out.println("");
		...
		System.out.println("Finished processing sentiment analysis. Sentiment: "+ Math.round(mainSentiment/senCounter));
		return Math.round(mainSentiment/senCounter);
	}
